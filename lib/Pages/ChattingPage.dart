...
class ChatScreenState extends State<ChatScreen>
{
  ...
  createStickers()
  {
    return Container(
      ...
      decoration: BoxDecoration(border: Border(top: BorderSide(color: Colors.red, width: 0.5)), color: Colors.white),
                  ...
                  ? Container(
                       child: Text(
                         DateFormat("dd MMMM, yyyy - hh:mm:aa")
                             .format(DateTime.fromMillisecondsSinceEpoch(int.parse(document["timastamp"]))),
